...
from Preprocessing.data_loading import split_dataset
from Preprocessing.config.graph_keys import EDGE_MAP_RGLIB_REVERSE
...
def get_loader(dataset,
    ...
    :param RGCN.data_loading.RNADataset dataset: Dataset for loading.
