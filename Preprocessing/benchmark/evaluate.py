...
from Preprocessing.data_loading import graphloader, get_all_labels
from Preprocessing.learning import learn
...
def get_performance(node_target, model, node_features=None, evaluation_function=roc_auc_score,test_loader = None):
    ...
    loss, mcc, precision,  recall = learn.evaluate_model_supervised(model=model, validation_loader=test_loader,
                                           evaluation_function=evaluation_function)
    return loss, mcc, precision,  recall
